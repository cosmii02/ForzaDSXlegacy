namespace ForzaDSX
{
	public struct Settings
	{
		...
		public int ACCELRATION_LIMIT { readonly get => _acceleration_Limit; set => _acceleration_Limit = value; }
		...
		public bool Verbose { readonly get => _verbose; set => _verbose = value; }
	}
}